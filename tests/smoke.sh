...
for fn in self_offline_bundle_create self_offline_bundle_install monitor_alert_check monitor_alert_config_menu monitor_alert_home_menu monitor_alert_daily_report monitor_alert_host_label monitor_alert_notify; do
